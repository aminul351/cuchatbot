...
import { EEE_FACULTY, CSE_FACULTY, LAW_FACULTY , ARTS_HUMANITIES_FACULTY,SCIENCE_FACULTY , BUSINESS_FACULTY, BIOLOGICAL_SCIENCES_FACULTY,SOCIAL_SCIENCES_FACULTY,EDUCATION_FACULTY , MARINE_SCIENCES_FACULTY, UNIVERSITY_INFO} from '../faculty';

export const maxDuration = 30;

// ─── Combine all verified faculty data ───────────────────────────────────────
// To add a new department: import its const above, then add it to ALL_FACULTY.
const ALL_FACULTY = [EEE_FACULTY, CSE_FACULTY, LAW_FACULTY,ARTS_HUMANITIES_FACULTY,SCIENCE_FACULTY , BUSINESS_FACULTY, BIOLOGICAL_SCIENCES_FACULTY,SOCIAL_SCIENCES_FACULTY,EDUCATION_FACULTY , MARINE_SCIENCES_FACULTY, UNIVERSITY_INFO].join('\n');
// ─────────────────────────────────────────────────────────────────────────────
